                      ...
                      bool $fromPattern) {
                        ...
                        echo \var_export($command->argsCount);
                            if ($guild->available == false) { //if in DM
                                ...
                                return $context->reply('Извини но эта команда не доступна для серверов. Хочешь ею воспользоваться ? Напиши мне в ЛС'); // тут еще можно вывести количество всех дз но только после того как определим новый формат
                            }
        }
    });
};